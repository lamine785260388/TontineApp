    ...
    <h1>Gérer ma tontine</h1>
    <p class="fs-5 col-md-8">Facilement gérer sa tontine. Une interface conciviable, envoi de sms de rappel,suivi des cotisations, paramétrage d'une tontine, attribution des droits</p>
