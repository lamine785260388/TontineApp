...
<table class="table">
    ...
    foreach($listeTontineResp as $tontine):
         ?>
         <tr><td><?= $tontine['nom'] ?></td><td><?= $tontine["périodicité"] ?></td>
        ...
        <a href="<?= base_url("adherent/supprimerTontine/".$tontine["id"])?>" class="btn btn-danger">supprimer</a>
        <a href="<?= base_url("adherent/participantTontine/".$tontine["id"])?>" class="btn btn-primary">Participant</a>
        </td>
         <?php endforeach ;?>
        </tr>
        <?php endif ;?>
